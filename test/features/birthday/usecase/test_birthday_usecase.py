...
def test_should_filter_by_excluded_employee_ids():
    ...
    test_employees = [
        Employee(
            ...
            name="Test",
            lastName="Test123",
            dateOfBirth=datetime(1960, 3, 13, 0, 0),
    ...
    filtered_employees = BirthdayNotificationUseCaseImpl.filter_excluded_employees(
        test_employees, [id_to_exclude]
    )
...
def test_should_return_employees_that_have_birthday_of_given_date(monkeypatch):
    ...
    employees_who_have_birthdays = use_case._filter_by_employees_birthdays(
        test_employees, given_date
    )
...
def test_should_return_employees_that_have_birthday_of_given_date_in_leap_years(
    monkeypatch,
):
